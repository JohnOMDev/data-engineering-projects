...
# CREATE TABLES
crm_table_create = (""" CREATE TABLE IF NOT EXISTS crm (crm_id SERIAL, account_id varchar(250) NOT NULL,
                         event_type varchar(200) NOT NULL, event_date date NOT NULL,
                         PRIMARY KEY(crm_id))
""")


sale_table_create = (""" CREATE TABLE IF NOT EXISTS sales (sale_id SERIAL, account_id varchar(250)  NOT NULL,
